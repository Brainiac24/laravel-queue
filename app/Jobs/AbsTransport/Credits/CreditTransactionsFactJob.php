...
class CreditTransactionsFactJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            $this->res_data = $transportService->getCreditService()->getDocumentService()->factListRequest($this->data['session_id'], $this->data['user_id'], $this->data['credit_id']);
            ...
            if ($arr['root']['response']['state'] ?? '0' == '1') {
                ...
                throw new \Exception("BUS_RESPONSE_STATE_IS_NOT_SUCCESS EO_R_CREDITS_ITEM_TRANSACTIONS_FACT");
