...
use App\Jobs\AbsTransport\Credits\CreditListCallbackJob;
...
class CreditListJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            $this->res_data = $transportService->getCreditService()->listRequest($this->data['session_id'], $this->data['user_id']);
            ...
            if ($arr['root']['response']['state'] ?? '0' == '1') {
                ...
                CreditListCallbackJob::dispatch($dataCallback)->onQueue(QueueEnum::REQUEST);*/
                throw new \Exception("BUS_RESPONSE_STATE_IS_NOT_SUCCESS EO_R_CREDIT_LIST");
