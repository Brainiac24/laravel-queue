...
class CardTransactionsJob implements ShouldQueue
{
    ...
    public static function rules()
    {
        return [
            ...
            'acc_number' => 'required|digits_between:16,20',
    ...
    public function handle()
    {
        ...
        try {
            ...
            $this->res_data = $transportService->getCardService()->itemTransactionsRequest($this->data['session_id'], $this->data['user_id'], $this->data['acc_number'], $this->data['date_start'], $this->data['date_end']);
