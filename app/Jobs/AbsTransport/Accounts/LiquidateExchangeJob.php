...
class LiquidateExchangeJob implements ShouldQueue
{
    ...
    public static function rules()
    {
        return [
            ...
            'cont_curr_code' => 'required|numeric',
    ...
    public function handle()
    {
        ...
        try {
            ...
            $this->res_data = $transportService->getAccountService()->getDocumentService()->liquidateExchangeRequest(
            ...
            if ($arr['root']['response']['state'] ?? '0' == '1') {
                ...
                LiquidateTransactionCallbackJob::dispatch($dataCallback)->onQueue(QueueEnum::PROCESSING);
