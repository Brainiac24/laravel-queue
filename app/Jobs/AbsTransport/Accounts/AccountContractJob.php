...
class AccountContractJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            $this->res_data = $transportService->getAccountService()->AccountCodecRequest(
            ...
            if ($arr['root']['response']['state'] ?? '0' == '1') {
                ...
                AccountCodecCallbackJob::dispatch($dataCallback)->onQueue(QueueEnum::REQUEST);*/
                ...
                throw new \Exception("BUS_RESPONSE_STATE_IS_NOT_SUCCESS EO_R_ACCOUNTS_ITEM_CODEC");
            }
            ...
            AccountContractCallbackJob::dispatch($dataCallback)->onQueue(QueueEnum::REQUEST);
            throw $conEx;
        } catch (\Throwable $th) {
