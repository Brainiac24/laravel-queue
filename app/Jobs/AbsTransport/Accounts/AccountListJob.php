...
use App\Jobs\AbsTransport\Accounts\AccountListCallbackJob;
...
class AccountListJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            $this->res_data = $transportService->getAccountService()->AccountListRequest(
            ...
            if ($arr['root']['response']['state'] ?? '0' == '1') {
                ...
                //CallbackJob::dispatch($dataCallback)->onQueue(QueueEnum::REQUEST);
                ...
                AccountListCallbackJob::dispatch($dataCallback)->onQueue(QueueEnum::REQUEST);*/

                throw new \Exception("BUS_RESPONSE_STATE_IS_NOT_SUCCESS EO_R_ACCOUNTS_LIST");
            }
