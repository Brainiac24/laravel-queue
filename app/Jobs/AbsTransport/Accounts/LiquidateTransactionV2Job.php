...
use App\Jobs\AbsTransport\Accounts\LiquidateTransactionCallbackJob;
use App\Jobs\AbsTransport\Accounts\LiquidateTransactionCallbackV2Job;
...
class LiquidateTransactionV2Job implements ShouldQueue
{
    ...
    public static function rules()
    {
        return [
            ...
            'doc_id' => 'numeric|numeric',
            'doc_num' => 'required|nullable',
            ...
            'commission_abs_doc_id' => 'string|nullable',
        ];
    }
    ...
    public function handle()
    {
        ...
        try {
            ...
            $this->res_data = $transportService->getAccountService()->getDocumentServiceV2()->liquidateTransactionRequest(
                ...
                $this->data['commission_abs_doc_id']??null
            );
            ...
            if ($arr['root']['response']['state'] ?? '0' == '1') {
                ...
                LiquidateTransactionCallbackV2Job::dispatch($dataCallback)->onQueue(QueueEnum::PROCESSING);
