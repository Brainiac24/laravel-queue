...
class AccountTransactionListJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            $this->res_data = $transportService->getAccountService()->AccountTransactionListRequest(
            ...
            if ($arr['root']['response']['state'] ?? '0' == '1') {
                ...
                throw new \Exception("BUS_RESPONSE_STATE_IS_NOT_SUCCESS EO_R_ACCOUNTS_ITEM_TRANSACTIONS");
                /*$dataCallback = AbsHelper::data(
                    $this->data['session_id'],
                    false,
                    null,
