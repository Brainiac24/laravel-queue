...
use App\Jobs\AbsTransport\Accounts\DepositCloseCallbackJob;
...
class DepositCloseJob implements ShouldQueue
{
    ...
    public static function rules()
    {
        return [
            ...
            'user_accept_id' => 'required|numeric',
            'act_type' => 'required|numeric',
            'client_acc_abs_id' => 'required|numeric',
            'com_client_acc_abs_id' => 'required|numeric',
        ];
    }
    ...
    public function handle()
    {
        ...
        try {
            ...
            $this->res_data = $transportService->getAccountService()->CloseDeposit(
                $this->data['session_id'],
                $this->data['on_date'],
                $this->data['dog_id'],
                $this->data['user_accept_id'],
                0, // 0-моновалютные проводки; кросс курс - мультивалютные проводки
                $this->data['act_type'],
                $this->data['client_acc_abs_id'],
                $this->data['com_client_acc_abs_id']
            );
            ...
            if ($arr['root']['response']['state'] ?? '0' == '1') {
               ...
               /* $dataCallback = AbsHelper::data(
                ...
                DepositCloseCallbackJob::dispatch($dataCallback)->onQueue(QueueEnum::REQUEST);
                */
