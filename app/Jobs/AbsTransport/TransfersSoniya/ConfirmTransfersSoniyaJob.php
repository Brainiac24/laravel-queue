...
use App\Jobs\AbsTransport\TransfersSoniya\ConfirmTransfersSoniyaCallbackJob;
...
class ConfirmTransfersSoniyaJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            $this->res_data = $transportService->getTransfersSoniyaService()->confirmRequest(
            ...
            if ($arr['root']['response']['state'] ?? '0' == '1') {
                ...
                ConfirmTransfersSoniyaCallbackJob::dispatch($dataCallback)->onQueue(QueueEnum::PROCESSING);
