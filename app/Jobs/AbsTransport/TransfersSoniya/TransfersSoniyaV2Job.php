...
use App\Jobs\AbsTransport\TransfersSoniya\TransfersSoniyaCallbackV2Job;

class TransfersSoniyaV2Job implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            $this->res_data = $transportService->getTransfersSoniyaService()->createRequestV2(
            ...
            if ($arr['root']['response']['state'] ?? '0' == '1') {
                ...
                TransfersSoniyaCallbackV2Job::dispatch($dataCallback)->onQueue(QueueEnum::PROCESSING);
