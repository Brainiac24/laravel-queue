...
use App\Jobs\BpcVisaTransport\BpcVisaCard2CardCallbackJob;
...
class BpcVisaCard2CardJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            if (is_object($this->res_data) && isset($this->res_data->responseCode) && $this->res_data->responseCode == BpcVisaStatus::OK) {
                ...
                BpcVisaCard2CardCallbackJob::dispatch($dataCallback->getData())->onQueue(QueueEnum::PROCESSING);
