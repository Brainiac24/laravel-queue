...
use App\Jobs\BpcVisaTransport\BpcVisaGetTransactionsCallbackJob;
...
class BpcVisaGetTransactionsJob implements ShouldQueue
{
...
//            'ext_id' => 'required|numeric',
    ...
    public function handle()
    {
        ...
        try {
            ...
            if (is_object($this->res_data) && count($this->res_data->transactions->transaction)>0) {
                ...
                BpcVisaGetTransactionsCallbackJob::dispatch($dataCallback->getData())->onQueue(QueueEnum::PROCESSING);
