...
use App\Jobs\BpcVisaTransport\BpcVisaFillCardCallbackJob;
...
class BpcVisaFillCardJob implements ShouldQueue
{
...
//            'ext_id' => 'required|numeric',
    ...
    public function handle()
    {
        ...
        try {
            ...
            $this->res_data = $transportService->FillCard(
            ...
            if (is_object($this->res_data) && isset($this->res_data->responseCode) && $this->res_data->responseCode == BpcVisaStatus::OK) {
                ...
                BpcVisaFillCardCallbackJob::dispatch($dataCallback->getData())->onQueue(QueueEnum::PROCESSING);
