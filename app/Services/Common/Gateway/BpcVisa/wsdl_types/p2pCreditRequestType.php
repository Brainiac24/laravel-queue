...
class p2pCreditRequestType
{
  ...
  /**
   * 
   * @var cardNumberType $debitedCardNumber
   * @access public
   */
  public $debitedCardNumber = null;
   ...
   * @param cardNumberType $debitedCardNumber
   ...
   * @access public
   */
  public function __construct($cardIdentification, $amount, $currency, $accountNumber, $tds, $senderReceiverInfo, $pointOfServiceDataCode, $pointOfServiceConditionCode, $cardAcceptorParameters, $securityLevelIndicator, $debitedCardNumber, $externalRRN, $originalTransactionParameters, $posCardholderPresence, $businessApplicationIdentifier, $mcTransactionTypeIndicator)
  {
    ...
    $this->debitedCardNumber = $debitedCardNumber;
