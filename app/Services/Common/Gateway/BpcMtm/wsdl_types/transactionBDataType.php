...
class transactionBDataType
{
  ...
  /**
   * 
   * @var terminalAddressType $terminalAddress
   * @access public
   */
   ...
   * @param terminalAddressType $terminalAddress
   * @param mccType $mcc
   * @access public
   */
  public function __construct($cardNumber, $expiryDate, $cardSequenceNumber, $utrnno, $reversal, $responseCode, $transactionType, $transmissionDate, $trace, $localTransactionDate, $referenceNumber, $authorizationIdResponse, $processingCode, $amount, $currency, $accountNumber, $terminalAddress, $mcc)
  {
